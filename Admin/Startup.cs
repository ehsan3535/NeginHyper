...
using NToastNotify;
using Services.BackgroundTasks.BirthdayTask;
...
namespace Admin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<PassedSessionCheckerBackGroundTask>();
            services.AddHostedService<ShopCardCleanerBackgroundTask>();
            ...
            }).AddNToastNotifyNoty(new NotyOptions
            {
                ...
                ProgressBar = true,
                Modal = true,
                // Change Custome Layout : topRight", "top", "topLeft", "topCenter", "center", "centerLeft", "centerRight","bottom","bottomLeft","bottomCenter","bottomRight"
                Layout = "topCenter",
                // Change Custome Theme : metroui,relax,nest,semanticui,sunset,mint,bootstrap-v3,light,bootstrap-v4,
                Theme = "metroui",
            })
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(config =>
            {
                ...
                config.MapControllerRoute(
                       name: "default",
    pattern: "{controller=home}/{action=index}/{id?}"); // Map default route {controller=Home}/{action=Index}/{id?}
            });
